        ...
        <div className="h-full py-24 flex justify-center">
          <div className="w-1/2 flex flex-col justify-center items-center text-center md:gap-12">
            ...
            <Text variant="body" className="text-gray-500">
              ...
              make informed buying decisions. Whether you're a seasoned bargain
              hunter or just looking for some inspiration, SmuggleBuy is the
              perfect place to start your shopping journey.
            </Text>
